...
const Navbar = () => {
    ...
    const dispatch = useDispatch(); // didperse actions from reducers
    ...
    const fullName: "firstName" = "Allan";
    ...
    return (
        <FlexBetween padding="1rem 6%" background={alt}>
            <FlexBetween gap="1.75rem">
                <Typography
                    fontWeight="bold"
                    fontSize="clamp(1rem, 2rem, 2.25rem)" // small screen, medium, large screen
                    color="primary"
